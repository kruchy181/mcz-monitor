"""
MCZ Easy Connect Monitor - STEP 11
Tryb analizy rejestrów
"""
...
def print_snapshot(vals,offset_map):
    ...
    for k in sorted(vals):
        ...
        if k in offset_map:
            print(f"{k}={offset_map[k]}={vals[k]}")
        else:
            print(f"{k}={vals[k]}")

    print("--------------------------------")

def monitor(reg_map,offset_map,vals,name,product):
    ...
    print("MCZ MONITOR (ANALYSIS MODE)")
    print("================================")
    print(name,"(",product,")")
    print("--------------------------------")

    print("STATUS        :",status_name,"(raw:",status,")")
    print("REAL POWER    :",power_raw,"(RAW)")
...
def main():
    ...
    while True:
        ...
        if job:
            ...
            monitor(reg_map,offset_map,vals,name,product)
