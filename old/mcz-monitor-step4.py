"""
MCZ Easy Connect Monitor v9 - STEP 4
Dodano:
- debug raw registers
"""
...
def print_registers(values_dict):

    print("\nRAW REGISTERS")
    print("--------------------------------")

    for k in sorted(values_dict):
        print(f"{k} : {values_dict[k]}")
...
def print_status(reg_map,values_dict):
    ...
    print("\n==================================================")
    print("MCZ Monitor -",now)
    print("==================================================")

    print("STATUS:",s_name,"(raw=",status,")")
    print("ALARM :",a_name,"(raw=",alarm,")")
...
def main():
    ...
    print("==================================================")
    print("MCZ Easy Connect Monitor v9 - STEP 4")
    print("==================================================")
    ...
    print("\n[*] Monitorowanie co",CHECK_INTERVAL,"s\n")
    ...
    while True:
        ...
        if job:
            ...
            if DEBUG_REGISTERS:
                print_registers(vals)

        else:

            print("[!] Brak danych")

        print("\n[*] Nastepny odczyt za",CHECK_INTERVAL,"s")
